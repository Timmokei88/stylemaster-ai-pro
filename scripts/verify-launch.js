...
const checks=[
 ...
 ["responsive image enhancer",html.includes('mixo-free-enhancer-v106')&&html.includes("fetch('/api/images/enhance'")&&server.includes('sharp(image.buffer')&&html.includes('2K / 4K / 8K Enhance')&&html.includes('300 DPI')],
