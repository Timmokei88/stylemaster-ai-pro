...
const checks=[
 ...
 [html.includes('upscaler.upscale')&&html.includes('patchSize:targetEdge===7680?16:32')&&html.includes('padding:2'), 'responsive 16/32-pixel patch neural super-resolution is present'],
 [html.includes('value="2048">2K Enhanced')&&html.includes('value="4096">4K Enhanced')&&html.includes('value="7680">8K Ultra Enhanced'), '2K, 4K, and 8K output targets are available'],
 [html.includes('passes=targetEdge===2048?1:2'), 'higher output targets use two neural detail passes'],
 [html.includes('async function renderTarget')&&html.includes('const strip=512'), 'large exports render in yielded strips to protect responsiveness'],
 ...
 [html.includes('targetEdge>=4096&&!window.confirm'), '4K and 8K work requires explicit confirmation'],
