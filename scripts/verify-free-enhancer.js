...
const checks=[
 ...
 [html.includes('upscaler.upscale')&&html.includes('patchSize:64'), 'patch-based neural super-resolution is present'],
 ...
 [html.includes("detailPass(canvas,.22+(finish-1)*1.8,2.1)"), 'post-neural detail finishing is present'],
