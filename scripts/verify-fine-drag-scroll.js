...
const checks=[
 [html.includes('mixo-fine-drag-scroll-v87'), 'V87 fine drag scrollbar is installed'],
 [html.includes('scrollbar-width:none!important'), 'uncontrolled native left scrollbar is hidden'],
 [html.includes("startScroll+(naturalMovement*.22)"), 'thumb dragging uses exactly 22% sensitivity'],
 [html.includes("settings.clientHeight*.22"), 'track clicks use 22% page movement'],
