...
const checks=[
 ...
 [html.includes('Manual — use only my measurements'),"strict supplied-measurement mode"],
 [html.includes('Automatic — estimate from description'),"automatic conceptual-measurement mode"],
 ...
 [html.includes('AI-ESTIMATED DIMENSIONS — VERIFY BEFORE USE — NOT FOR FABRICATION'),"automatic estimate warning"],
