...
app.get("/",(req,res)=>{const h=fs.readFileSync(path.join(__dirname,"index.html"),"utf8");res.type("html").send(h.replace("</body>",'<script src="/random-infinite.js"></script></body>'));});
